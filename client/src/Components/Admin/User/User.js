                ...
                <table class="min-w-full leading-normal ">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <button type="button" class="  inline-block px-6 py-2.5 bg-blue-600 text-white font-medium text-xs leading-tight uppercase rounded-full shadow-md hover:bg-blue-200 hover:shadow-lg focus:bg-purple-400 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-purple-200 active:shadow-lg transition duration-150 ease-in-out"  onClick={(e) => { UnblockUser(obj._id) }}>UNBLOCK</button>
                            }
                        </td>              
                        </tr>
                                    )
